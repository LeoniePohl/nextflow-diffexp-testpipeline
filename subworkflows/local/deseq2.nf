...
workflow DESEQ2 {
    ...
    ch_in_raw
    ch_feature
    // TODO subread output: feature counts
    ...
    matrix_as_anno_filename = "matrix_as_anno.tsv"//${matrix_file.getExtension()}"
   ...
   //ch_features = ch_in_raw
    ...
    ch_matrix_for_differential.view()
    VALIDATOR.out.sample_meta.view()
   ...
   /* RMARKDOWNNOTEBOOK(
    ...
    emit:
    versions = CUSTOM_DUMPSOFTWAREVERSIONS.out.versions // channel: [ versions.yml ]
